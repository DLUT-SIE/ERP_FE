...
import './SteelBarMaterialRefundCardTable.less'
import { MATERIAL_REFUND_CARD_TYPE } from 'const'

class SteelBarMaterialRefundCardTable extends React.Component {
  constructor (props) {
    super(props)
    this.state = {}
  }
        ...
        <div className='wrapper'>
          ...
          <table className='table-info'>
            <tbody>
              ...
              {this.iterateValues(refundCard.bar_details, refundCard.pretty_status)}
...
SteelBarMaterialRefundCardTable.propTypes = {
  details: PropTypes.object.isRequired,
  changeStatus: PropTypes.func.isRequired
}

export default SteelBarMaterialRefundCardTable
