...
import './BroughtInMaterialEntryCardTable.less'

class BroughtInMaterialEntryCardTable extends React.Component {
  constructor (props) {
    super(props)
    this.state = {}
  }
  ...
  render () {
    ...
    return (
      <div className='brought-in-material-entry-card-table'>
        ...
        <div className='wrapper'>
          <Row>
            ...
            <Col span={6}>
              <span className='outline'>订购单编号：{entryCard.bidding_sheet}</span>
            </Col>
            <Col span={8}>
              <span className='outline'>接收检查记录表编号：{entryCard.inspection_record}</span>
            </Col>
            <Col span={5}>
...
BroughtInMaterialEntryCardTable.propTypes = {
  details: PropTypes.object.isRequired,
  changeStatus: PropTypes.func.isRequired
}

export default BroughtInMaterialEntryCardTable
