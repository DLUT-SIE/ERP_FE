...
const columns = [
  'create_dt', 'common_uid', 'source', 'purchaser', 'inspector', 'pretty_steel_type', 'action'
]
const entryStatus = {
          ...
          if (record.status === entryStatus.ENTRYSTAUS_CHOICES_KEEPER) {
            return (
              <Button
                ...
                data-id={record.uid}
              >
                <Link to={`/inventory/steel/steel_entry/${record.uid}/`}>待处理</Link>
              </Button>
            )
          } else {
            return (
              <Button
                ...
                data-id={record.uid}
              >
                <Link to={`/inventory/steel/steel_entry/${record.uid}/`}>详情</Link>
              </Button>
            )
          }
        }
