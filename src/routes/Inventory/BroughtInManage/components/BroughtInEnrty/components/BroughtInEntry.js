...
const columns = [
  'common_uid', 'create_dt', 'source', 'material_type', 'purchaser', 'action'
]
const entryStatus = {
          ...
          if (record.status === entryStatus.ENTRYSTAUS_CHOICES_KEEPER) {
            return (
              <Button
                ...
                size='small'
              >
                <Link to={`/inventory/brought_in/brought_in_entry/${record.id}/`}>待处理</Link>
              </Button>
            )
          } else {
            return (
              <Button
                ...
                size='small'
              >
                <Link to={`/inventory/brought_in/brought_in_entry/${record.id}/`}>详情</Link>
              </Button>
            )
          }
        }
