...
import BroughtInEntryDetailTr from './BroughtInEntryDetailTr'
import DetailModal from './DetailModal'
import './BroughtInEntry.less'

class BroughtInEntry extends React.Component {
  constructor (props) {
    super(props)
    this.state = {}
  ...
  handleSave = (id, fieldsValue) => {
    fetchAPI(apis.PurchaseAPI.updateBoughtInComponentEntryDetail, fieldsValue, { id }).then((repos) => {
